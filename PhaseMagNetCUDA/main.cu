...
int main()
{
    ...
    if (mnist)
    {
        char* modelName = "lenet5_phasor3b_chkpt0.txt";
        char* saveName = "lenet5_phasor3b_chkpt1.txt";
        ...
        char* testName = "..\\..\\..\\..\\mnist\\t10k-images.idx3-ubyte"; // mnist_net1.pth_eps0.100.idx3-ubyte
